...
public class StartedAccountBalanceIntentHandler extends BaseHandler implements IntentRequestHandler {
		
    @Override
    public boolean canHandle(HandlerInput input, IntentRequest intentRequest) {
        return (input.matches(intentName(IntentNameConstants.CUSTOM_ACCOUNT_BALANCE_INTENT))
