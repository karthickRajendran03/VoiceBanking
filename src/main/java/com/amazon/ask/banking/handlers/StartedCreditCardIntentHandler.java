...
public class StartedCreditCardIntentHandler extends BaseHandler implements IntentRequestHandler {
		
    @Override
    public boolean canHandle(HandlerInput input, IntentRequest intentRequest) {
        return (input.matches(intentName(IntentNameConstants.CUSTOM_CREDIT_CARD_INTENT))
