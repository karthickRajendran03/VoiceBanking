...
public class SpeechTextsConstants {
	...
	public static final String PIN_SUCCESS_LINK_BANK_SPEECH_TEXT = "Your Voice PIN is verified. Please provide the Routing Number for verification";
	...
	public static final String ACCOUNT_NUMBER_INVALID = "Account Number is invalid, Please provide the valid account number to proceed further";
	public static final String CREDIT_CARD_PROCESS = "You have one credit card account ending with 1111 having due date of December 20 2020, Do you want to proceed with the  payment";
