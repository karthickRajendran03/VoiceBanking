...
public class StartedPersonalLoanIntentHandler extends BaseHandler implements IntentRequestHandler {
		
    @Override
    public boolean canHandle(HandlerInput input, IntentRequest intentRequest) {
        return (input.matches(intentName(IntentNameConstants.CUSTOM_PERSONAL_LOAN_INTENT))
